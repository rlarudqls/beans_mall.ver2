		...
		<div class="admin_content_main">
			<form action="/admin/goodsModify" method="post" id="modifyForm">
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input name="price" value="${goodsInfo.beanPrice}"> <span
							class="ck_warn price_warn">가격을 입력해주세요.</span>
					</div>
				</div>
				<div class="form_section">
					<div class="form_section_title">
					...
					<div class="form_section_content">
						<input name="stock" value="${goodsInfo.beanStock}"> <span
							class="ck_warn stock_warn">재고수량을 입력해주세요.</span>
					</div>
				</div>
				<div class="form_section">
					<div class="form_section_title">
			...
			<form action="/admin/goodsDelete" method="post" id="deleteForm"
				style="display: none;">
